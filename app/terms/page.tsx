      ...
      <section className="px-4 pt-28 pb-16 md:px-6 md:pt-36 md:pb-24 lg:px-8">
        <div className="mx-auto max-w-4xl space-y-12">
          <header className="space-y-6 text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-gold-100 px-5 py-2.5 text-sm font-medium text-gold-700 shadow-sm">
            ...
            <p className="mx-auto max-w-3xl text-base text-gray-600 md:text-lg leading-relaxed">
              ...
              . These terms outline the rules and responsibilities when you
              interact with the NexGenAds ecosystem operated by NexGenAds
              Technologies Private Limited (&quot;NexGenAds&quot;), a company
              incorporated in 1/53, Keerthy Complex, opp to Police station,
              Periyanayackanpalayam, Coimbatore-641020.
            </p>
          </header>
          ...
          <section className="rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-brand-50 p-6 md:p-8 shadow-lg">
            <p className="text-sm md:text-base text-gray-600 leading-relaxed">
              ...
              <a
                className="font-semibold text-brand-600 hover:text-brand-800 underline-offset-4 hover:underline"
                href="mailto:legal@nexgenads.space"
              >
