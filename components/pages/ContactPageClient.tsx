...
const contactInfo: ContactInfo[] = [
  ...
  },
  {
    ...
    title: "Location",
    value:
      "1/53, Keerthy Complex, opp to Police station, Periyanayackanpalayam, Coimbatore-641020",
    link: "#map",
  },
];
      ...
      <section className="relative overflow-hidden border-b border-border bg-gradient-to-br from-brand-50/60 via-white to-gold-500/10">
        <div className="container-custom px-4 pt-28 pb-16 md:px-6 md:pt-36 md:pb-24 text-center lg:px-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-[#008dec] font-semibold">NexGenAds</span>?
            We&apos;d love to hear from you.
          </p>
          <p className="mt-3 text-sm text-muted-foreground">
            NexGenAds Technologies Private Limited · 1/53, Keerthy Complex, opp
            to Police station, Periyanayackanpalayam, Coimbatore-641020
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 mb-12 md:mb-16">
            {contactInfo.map((info, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-12 h-12 md:w-16 md:h-16 rounded-xl bg-gradient-to-br ${gradients[index]} flex items-center justify-center mx-auto mb-3 md:mb-4 group-hover:scale-110 transition-transform shadow-md`}
                  >
                    <info.icon className="w-6 h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  <h3 className="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2 group-hover:text-brand-600 transition-colors">
                    {info.title}
                  </h3>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl border border-brand-200 shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                <span className="w-10 h-10 rounded-xl bg-brand-gradient flex items-center justify-center text-white text-lg font-bold shadow-md">
                  1
                </span>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {submitMessage && (
                  <div
                    className={`p-4 rounded-xl font-medium shadow-md text-center ${
                  ...
                  >
                    <div className="flex items-center justify-center gap-2">
                      <span className="text-xl">
                        {submitMessage.includes("Thank") ? "✅" : "⚠️"}
                      </span>
                      {submitMessage}
                    </div>
                  </div>
            ...
            <div className="space-y-8">
              <div
                id="map"
                className="bg-white/80 backdrop-blur-sm p-4 rounded-xl border border-brand-200 shadow-lg h-80"
              >
                <iframe
              ...
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl border border-gold-200 shadow-lg">
                <div className="flex items-center gap-3 mb-6">
                  <span className="w-10 h-10 rounded-xl bg-brand-500 flex items-center justify-center text-white text-lg font-bold shadow-md">
                    2
                  </span>
