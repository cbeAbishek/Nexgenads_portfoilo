...
export const metadata: Metadata = {
  ...
  description:
    "NexGenAds is an AI-driven technology company helping businesses build, automate, and scale. Website & app development, ERP/CRM, AI automation, AI chatbots, SaaS, digital marketing, SEO, GEO & AEO.",
  keywords: [
