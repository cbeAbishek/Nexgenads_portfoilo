...
export const metadata: Metadata = {
  title:
    "1Grow | Sales & Marketing OS by NexGen - CRM, AI & WhatsApp Automation",
  description:
    "1Grow is an enterprise SaaS platform by NexGen that unifies CRM, lead management, AI assistance, WhatsApp integration, marketing automation, analytics, and reporting. Book a demo.",
  keywords:
