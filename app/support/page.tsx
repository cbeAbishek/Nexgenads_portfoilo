      ...
      <section className="section-padding">
        <div className="container-custom max-w-5xl space-y-16">
          <header className="space-y-4 text-center">
            ...
            <p className="mx-auto max-w-2xl text-base text-[#333333] md:text-lg">
          ...
          {/* <section className="grid gap-8 rounded-3xl border border-[#1d36bf]/15 bg-gradient-to-br from-[#00D9FF]/10 via-transparent to-[#A855F7]/10 p-8 md:grid-cols-2 md:items-center md:p-12">
            <div className="space-y-4">
              <ShieldCheck className="h-10 w-10 text-[#A855F7]" />
              <h2 className="text-2xl font-semibold text-[#000000]">Incident response promise</h2>
              ...
              <ol className="list-decimal space-y-2 pl-5 text-sm text-[#333333]">
          ...
          <footer className="text-center text-xs text-[#333333]/70">
