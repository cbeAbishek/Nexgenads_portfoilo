      ...
      <section className="section-padding bg-card/30">
        <div className="container-custom text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-12">
            Coming soon: Hear from our partners about their experiences
          </p>
          <div className="glass-effect-strong p-12 rounded-xl">
            <p className="text-muted-foreground">
              Success stories and testimonials will be featured here once we launch
            </p>
          </div>
        </div>
      </section>
