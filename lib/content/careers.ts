...
export const jobOpenings: JobOpening[] = [
  {
    ...
    experience:
      "Fresher with strong fundamentals in React, JavaScript, HTML, CSS",
    description:
      "Work on building and improving frontend features for our startup products using React.",
    responsibilities: [
    ...
    preferredSkills: ["Next.js", "Tailwind CSS", "Basic TypeScript knowledge"],
  ...
  },
  {
    ...
    description:
      "Build and maintain backend services and APIs for startup applications.",
    responsibilities: [
    ...
    preferredSkills: ["MongoDB", "JWT authentication", "Basic cloud knowledge"],
    postedDate: "2026-01-01",
    active: true,
  },
  {
    ...
    description:
      "Assist in building backend services, utilities, and business logic using Java.",
    responsibilities: [
  ...
  },
  {
    ...
    description:
      "Create engaging content for blogs, social media, and product documentation.",
    responsibilities: [
  ...
  },
  {
    ...
    description:
      "Design visual assets for web, mobile apps, and marketing materials.",
    responsibilities: [
    ...
    preferredSkills: ["Figma", "Adobe Photoshop", "Illustrator"],
    postedDate: "2026-01-01",
    active: true,
  },
  {
    ...
    description:
      "Focus on improving user experience and interface design for startup products.",
    responsibilities: [
    ...
    preferredSkills: ["Figma", "User research basics", "Design systems"],
    postedDate: "2026-01-01",
    active: true,
  },
  {
    ...
    description:
      "Test applications to ensure quality, usability, and reliability.",
    responsibilities: [
  ...
  },
  {
    ...
    description:
      "Support digital marketing efforts and learn startup growth strategies.",
    responsibilities: [
    ...
    preferredSkills: ["Social media platforms", "Basic analytics", "Canva"],
    postedDate: "2026-01-01",
    active: true,
  },
];
